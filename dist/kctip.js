...
var KCTip = (function () {
	...
	var KCTip = {
		...
		position: function position(pos) {
			...
			var coords = this['pos_' + (pos || this._pos || this.pos)](this.w, this.h);
		...
		hide: function hide(is_instant) {
			...
			if (this._pos == 'mouse') requestAnimationFrame(_hide_after);else this.timeout_fade = setTimeout(_hide_after, is_instant ? 0 : this.countdown_fade);
		},
	...
	function _onDOMReady() {
		...
		var querySelector = '[href^="http://fleet.moe/"], [href^="http://fleet.diablohu.com/"], [kctip]',
	...
	function KCTipMouseMove() {
		...
		// 超出Y轴上边界
		if (y - scrollTop <= 10) y = _y + 25 + scrollTop;
